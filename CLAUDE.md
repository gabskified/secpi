...
4. **Every flag change is a diff to `docs/FLAGS.md`.** Flags carry stable numbers. Never renumber. Check `docs/STATE.md` for the current next-free number rather than trusting any number hardcoded here — this file has already gone stale on this once. *(As of 2026-07-27: register runs through #95, next free is #96.)*
